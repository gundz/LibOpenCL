...
SRCS =			\
				openCLBuildProgram.c \
				openCLCreateKernel.c \
				openCLGetCommandQueue.c \
				openCLGetContext.c \
				openCLGetDeviceId.c \
				openCLGetProgram.c \
				openClGetProgramFromFile.c \
				OCL.c \
...
ifeq ($(OS), Linux)
LIB_SUPP_INC = -I $(AMDAPPSDKROOT)/include
else
LIB_SUPP_INC = -I/usr/local/cuda/include
endif
